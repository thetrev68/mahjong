...
**Files to modify:**
2. [mobile/MobileRenderer.js](../mobile/MobileRenderer.js) - Replace current `onTilesDealt()`
3. [mobile/styles/animations.css](../mobile/styles/animations.css) - Add tile reveal animations
...
/* Reveal animation */
.tile--revealing {
    animation: tile-reveal 300ms cubic-bezier(0.4, 0.0, 0.2, 1);
}
