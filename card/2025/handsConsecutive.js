...
export const handsConsecutive = {
    ...
    hands: [
        ...
        {
            description: "111 222 3333 DD DD (Any 3 Suits, Any 3 consec Nos v Opp Dragons)",
            vsuitCount: 3,
            concealed: false,
            odd: false,
            even: false,
        ...
        {
            description: "112345 1111 1111 (Any 5 Consec Nos, Pair Any Nos In Run, Kongs Match Pair)",
            vsuitCount: 5,
            concealed: false,
            odd: false,
            even: false,
