...
export class MobileGameController {
  ...
  async init() {
    ...
    this.opponentBars = [
      new OpponentBar(
        this.container.querySelector('.opponent-bar[data-position="right"]'),
        1,
        this.gameController,
      ),
      new OpponentBar(
        this.container.querySelector('.opponent-bar[data-position="top"]'),
        2,
        this.gameController,
      ),
      new OpponentBar(
        this.container.querySelector('.opponent-bar[data-position="left"]'),
        3,
        this.gameController,
      ),
    ];
