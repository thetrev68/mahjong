...
**Solution:** As detailed in the new `showHand` implementation in Section 5.3, exposed tile sets (pungs, kongs, quints) will be displayed on a second row _above_ the player's main hidden hand.
