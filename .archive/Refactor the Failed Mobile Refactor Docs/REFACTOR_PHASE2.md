...
```javascript
const BUTTON_CONFIG = {
  [STATE.START]: {show: ["start", "settings"], hide: ["button1", "button2", "button3", "button4", "sort1", "sort2"]},
  [STATE.DEAL]: {show: ["sort1", "sort2"], hide: ["button1", "button2", "button3", "button4"]},
  [STATE.CHARLESTON1]: {
    show: ["button1"],
  ...
  [STATE.LOOP_CHOOSE_DISCARD]: {
    ...
    text: {button1: "Discard", button2: "Exchange Joker", button3: "Mahjong!"},
