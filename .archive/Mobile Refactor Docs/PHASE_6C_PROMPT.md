...
<div class="bottom-menu">
  <button class="menu-btn menu-btn--primary" id="drawBtn">DRAW</button>
  <button class="menu-btn" id="sortBtn">SORT</button>
  <button class="menu-btn" id="mobile-settings-btn">⚙️ SETTINGS</button>
</div>
```
