...
const mockSpriteData = {
  frames: {
    "5C.png": {
      frame: { x: 676, y: 0, w: 52, h: 69 },
      sourceSize: { w: 52, h: 69 },
    },
    "3B.png": {
      frame: { x: 312, y: 0, w: 52, h: 69 },
      sourceSize: { w: 52, h: 69 },
    },
    "7D.png": {
      frame: { x: 1040, y: 0, w: 52, h: 69 },
      sourceSize: { w: 52, h: 69 },
    },
    "N.png": {
      frame: { x: 1872, y: 0, w: 52, h: 69 },
      sourceSize: { w: 52, h: 69 },
    },
    "S.png": {
      frame: { x: 1924, y: 0, w: 52, h: 69 },
      sourceSize: { w: 52, h: 69 },
    },
    "W.png": {
      frame: { x: 1976, y: 0, w: 52, h: 69 },
      sourceSize: { w: 52, h: 69 },
    },
    "E.png": {
      frame: { x: 1560, y: 0, w: 52, h: 69 },
      sourceSize: { w: 52, h: 69 },
    },
    "DB.png": {
      frame: { x: 1404, y: 0, w: 52, h: 69 },
      sourceSize: { w: 52, h: 69 },
    },
    "DC.png": {
      frame: { x: 1456, y: 0, w: 52, h: 69 },
      sourceSize: { w: 52, h: 69 },
    },
    "DD.png": {
      frame: { x: 1508, y: 0, w: 52, h: 69 },
      sourceSize: { w: 52, h: 69 },
    },
    "J.png": {
      frame: { x: 1820, y: 0, w: 52, h: 69 },
      sourceSize: { w: 52, h: 69 },
    },
    "F1.png": {
      frame: { x: 1612, y: 0, w: 52, h: 69 },
      sourceSize: { w: 52, h: 69 },
    },
    "F4.png": {
      frame: { x: 1768, y: 0, w: 52, h: 69 },
      sourceSize: { w: 52, h: 69 },
    },
  },
  meta: {
...
test.describe("MobileTile", () => {
  ...
  test.describe("Static Methods", () => {
    ...
    test("should handle sprite load failure gracefully", async () => {
      ...
      try {
        await expect(
          MobileTile.loadSprites("invalid.png", invalidData),
  ...
  test.describe("Edge Cases", () => {
    test("should handle missing sprite frame gracefully", async () => {
      await MobileTile.loadSprites("../assets/tiles.png", {
        frames: {},
        meta: { size: { w: 0, h: 0 } },
      });
      const tile = new MobileTile(mockTileData.CRACK_5);
