...
The most recently discarded tile is always considered the "Focus Tile." Only one tile can be in this state at a time. The Focus Tile is always rendered with a **blue glow effect**. This state persists until the *next* tile is discarded, at which point the glow is transferred to the new tile.
